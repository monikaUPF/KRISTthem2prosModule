...
class ConllToken2009(object):
    ...
    def __repr__(self):
        return '\t'.join([self.id, self.form, self.plemma, self.lemma, self.ppos,self.pos, self.pfeat, self.feat,self.phead,self.head,self.pdeprel,self.deprel,self.pred,self.fillpred, self.them])
